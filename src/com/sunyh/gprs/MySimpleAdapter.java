...
public class MySimpleAdapter extends BaseAdapter implements Filterable {
            ...
            if (v != null) {
                ...
                if (!bound) {
                	if (v instanceof TextView) {
                		if (i==0&&text.equals("设置阀值")){
                    		TextView	v2 = (TextView) view.findViewById(to[i]);
                    		v2.setText(Html.fromHtml("<u><h2 style=\"color:blue\">设置阀值</h2></u>"));
                		}else
     ...
     *
     * @see MySimpleAdapter#setViewImage(ImageView, int)
     * @see MySimpleAdapter#setViewImage(ImageView, String)
     * @see MySimpleAdapter#setViewText(TextView, String)
     */
